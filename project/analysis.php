...
<body>
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu2">各類不喜歡數量統計</a></li>
    <li><a data-toggle="tab" href="#menu3">收藏店家次數</a></li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div id="menu2" class="tab-pane fade">
      <h2 style="text-align: center;">各類不喜歡數量統計</h2>
      <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
      <script type="text/javascript">
      google.charts.load("current", {packages:["corechart"]});
      google.charts.setOnLoadCallback(drawChart);
      function drawChart() {
        var BadR=<?php echo $BadR ?>;
        var BadN=<?php echo $BadN ?>;
        var BadH=<?php echo $BadH ?>;
        var BadD=<?php echo $BadD ?>;
        var data = google.visualization.arrayToDataTable([
          ['店家', '不喜歡數'],
          ['飯類', BadR],
          ['麵類',BadN],
    ...
    <div id="menu3" class="tab-pane fade"><!--收藏店家次數-->
      <?php echo $Name[1]; ?>
